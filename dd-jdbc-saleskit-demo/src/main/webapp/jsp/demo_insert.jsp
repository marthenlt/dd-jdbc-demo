...
<link rel="stylesheet" type="text/css" media="screen" href="/html/css/common.css" />
<link rel="stylesheet" type="text/css" media="screen" href="/html/css/header.css" />
<link rel="stylesheet" type="text/css" media="screen" href="/html/css/contract.css" />
<link rel="stylesheet" type="text/css" media="screen" href="/html/css/administration.css" />

<link rel="stylesheet" type="text/css" media="screen" href="/html/css/popup.css" />
...
function doInsert3(){
	if(confirm("TYPE4 실행합니다.")){
		$.ajax({
	        type:"POST",
	        url:"/type5/demo/data/insert_batch.do",
...
<div class="tab-box1">
	<ul class="select lmargin30">
		<li class="dot1"></li>
		<li class="selecttitle">로우수 : <input name="V_LOOP_S" id="V_LOOP_S"  type="text" class="inputtextbox" style="width:60px;" value="1000" /></li>
	</ul>
</div>
<div class="tab-box1">
    <ul >
...
<div class="tab-box1">
	<ul class="select lmargin30">
		<li class="dot1"></li>
		<li class="selecttitle">로우수 : <input name="V_LOOP_B" id="V_LOOP_B"  type="text" class="inputtextbox" style="width:60px;" value="1000" /></li>
        <li class="selecttitle">배치수 : <input name="V_BATCH_B" id="V_BATCH_B"  type="text" class="inputtextbox" style="width:60px;" value="100" /></li>
	</ul>
</div>
<div class="tab-box1">
    <ul >
...
<div id="POPUP_LODDING" title="처리중..">
	<ul class="select">
		<li>
		<table border="0" cellspacing="0" cellpadding="0">
		  <tr>
