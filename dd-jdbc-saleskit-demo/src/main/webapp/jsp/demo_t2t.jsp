...
function doInsert1(){
	if(confirm("TYPE4 Run.")){
		$.ajax({
	        type:"POST",
	        url:"${pageContext.request.contextPath}/type5/demo/data/t2t_type4.do",
...
function doInsert2(){
	if(confirm("TYPE5 Run")){
		$.ajax({
	        type:"POST",
	        url:"${pageContext.request.contextPath}/type5/demo/data/t2t.do",
...
<body>
<div class="contents">
<h3># DEMO JDBC &gt; TABLE TO TABLE</h3>
...
<div class="section section2">
	<ul >
		<li class="section_title">TARGET : <input name="V_TARGET" id="V_TARGET"  type="text" class="inputtextbox" style="width:150px;" value="TMP_DEMO2" /></li>
	</ul>
</div>
