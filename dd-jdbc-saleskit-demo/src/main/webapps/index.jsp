...
<div class="contents center">
	<div align="center">
		<table >
			<tr>
				<td width="200" align="left"><img src="/html/css/Datec.png"></td>
				<td width="600">&nbsp;</td>
	...
	<div  class="btn_group">
		<ul >
			<li><a href="/type5/demo/select.do">&gt;&nbsp;&nbsp;DEMO : SELECT (SINGLE)</a></li>
			<li><a href="/type5/demo/select_multi.do">&gt;&nbsp;&nbsp;DEMO : SELECT (MULTI)</a></li>
			<!-- 
