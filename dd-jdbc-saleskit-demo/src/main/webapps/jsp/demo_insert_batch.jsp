...
VALUES (:C01, 
'152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500','152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500',
'152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500','152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500',
'152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500','152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500',
'152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500','152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500',
'152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500','152-790','서울시 구로구 구로3동','대륭포스트타워2차 314호','6259-1500',
...
<div class="section section2">
	<ul >
		<li class="section_title">로우수 : <input name="V_LOOP_B" id="V_LOOP_B"  type="text" class="inputtextbox" style="width:60px;" value="100" /></li>
        <li class="section_title">배치수 : <input name="V_BATCH_B" id="V_BATCH_B"  type="text" class="inputtextbox" style="width:60px;" value="100" /></li>
	</ul>
</div>
<div class="section section3">
    <ul >
		<li class="section3_1"><a href="javascript:doInsert3();">TYPE4</a> 
		<table border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td>
				<textarea rows="25" cols="45"  id="P_DETAIL_3" name="P_DETAIL_3"></textarea>
			</td>
		  </tr>
		</table>
		</li>
		<li class="section3_2"><a href="javascript:doInsert4();">Data Direct</a> 
		<table border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td>
				<textarea rows="25" cols="45"  id="P_DETAIL_4" name="P_DETAIL_4"></textarea>
			</td>
		  </tr>
		</table>
		</li>
